...
def parse_args():
    ...
    parser.add_argument(
        "--train_file", type=str, default=None, help="A file containing the training data."
    )
    parser.add_argument(
        "--validation_file", type=str, default=None, help="A file containing the validation data."
    )
    parser.add_argument(
        "--text_column_name",
        type=str,
